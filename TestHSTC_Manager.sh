...
declare -i NC HSTC HSTCC HSTCOld HSTCMN0 HSTCMN1 HSTCMN2 HSTCMN3 HSTCMN4 HSTCMN5 HSTCMN6 HSTCMN7 HSTCMN8 HSTCMN9 HSTCMN10
#Counter
NC=0
...
ADDNODE2=77.244.213.174
ADDNODE3=63.209.35.132
ADDNODE4=155.138.202.92
ADDNODE5=66.42.95.84
COINPORT=15600
COINRPCPORT=15700
...
HSTC_Logo(){
  ...
  echo "                                                                      ";
  echo -e "      ${Yellow}                                                                ";
  echo " __ __   ___    _____ ______  ____  ____    ____    __   ___  ____  ____  ";
echo "|  T  T /   \  / ___/|      Tl    j|    \  /    T  /  ] /   \l    j|    \ ";
echo "|  l  |Y     Y(   \_ |      | |  T |  _  YY   __j /  / Y     Y|  T |  _  Y";
echo "|  _  ||  O  | \__  Tl_j  l_j |  | |  |  ||  T  |/  /  |  O  ||  | |  |  |";
echo "|  |  ||     | /  \ |  |  |   |  | |  |  ||  l_ /   \_ |     ||  | |  |  |";
echo "|  |  |l     ! \    |  |  |   j  l |  |  ||     \     |l     !j  l |  |  |";
echo "l__j__j \___/   \___j  l__j  |____jl__j__jl___,_j\____j \___/|____jl__j__j";
echo -e "${GREEN}                                                           ";
  echo -e "                  ╔╦╗┌─┐┌─┐┌┬┐┌─┐┬─┐┌┐┌┌─┐┌┬┐┌─┐";
  echo -e "                  ║║║├─┤└─┐ │ ├┤ ├┬┘││││ │ ││├┤ ";
  echo -e "                  ╩ ╩┴ ┴└─┘ ┴ └─┘┴└─┘└┘└─┘─┴┘└─┘";
