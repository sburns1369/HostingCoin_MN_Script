...
sleep 3
sudo mv /root/hstc/hstcd /root/hstc/hstc-cli /usr/local/bin
...
hstcd -datadir=/home/hostingcoin3/.hostingcoin -daemon
sleep 20
echo -e ${YELLOW}"Launching Fourth HSTC Node"${CLEAR}
hstcd -datadir=/home/hostingcoin4/.hostingcoin -daemon
sleep 20
...
echo -e "${YELLOW}For mn3: \"hstc-cli -datadir=/home/hostingcoin3/.hostingcoin masternode status\""${CLEAR}
echo -e "${YELLOW}For mn4: \"hstc-cli -datadir=/home/hostingcoin4/.hostingcoin masternode status\""${CLEAR}
echo
